...
int main(int argc, char *argv[])
{
	...
	printf("print readers %d\n", ioctl(fd, DM510_PRINT_AUTHORS, 66)); //set number of read subscribers to 42, default is 10000
	printf("\n\ndm510_1:\n");
	...
	printf("print readers %d\n", ioctl(fd2, DM510_PRINT_AUTHORS, 66)); //set number of read subscribers to 42, default is 10000
